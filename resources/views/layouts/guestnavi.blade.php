<nav x-data="{ open: false }" class="border-b border-white-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="url('https://kuzushiji.work/')">
                        <b> {{ __('Return to Home') }}</b>
                    </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-white-200">
            <div class="px-4">
                <div class="font-medium text-sm text-white-500">*一番上のロゴをクリックすると清書リストに戻れます*</div>
            </div>
