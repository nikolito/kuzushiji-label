        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="ml-8 mr-8 mt-4">
                ...
                <p class="m-4">
                    ...
                    しかし、現状のくずし字データは日本文学（古典籍）やレシピといったいわゆる庶民にとって読みやすくひらがな多めの本から採取したものです。<br>
                    そのため、公文書や書状などの改まった「書き言葉」に多用される漢字中心の文書に対してOCRを行うと、精度が大幅に低下します。<br>
                    そこで、本システムを通じて、<span
                        class="text-orange-500 font-bold">現状のAI用くずし字データを積極的に補完し、誰でもくずし字データを無償で使用できるようにしたいと思います。</span>
                </p>
